...
class JsonProtocolSuite extends SparkFunSuite {
  ...
  test("SparkListenerEvent") {
    ...
    val executorRemoved = SparkListenerExecutorRemoved(executorRemovedTime, "exec2", "test " +
      "reason", null)
  ...
  test("SparkListenerJobStart backward compatibility") {
    ...
    val dummyStageInfos =
      stageIds.map(id => new StageInfo(id, 0, 0, "unknown", 0, None, Seq.empty, Seq.empty,
        "unknown"))
  ...
  test("StageInfo backward compatibility (parent IDs)") {
    ...
    val stageInfo = new StageInfo(1, 0, 1, "me-stage", 1, None, Seq.empty, Seq(1, 2, 3), "details")
    val oldStageInfo = JsonProtocol.stageInfoToJson(stageInfo).removeField({ _._1 == "Parent IDs"})
    val expectedStageInfo = new StageInfo(1, 0, 1, "me-stage", 1, None, Seq.empty, Seq.empty,
      "details")
...
private[spark] object JsonProtocolSuite extends Assertions {
  ...
  private def makeStageInfo(a: Int, b: Int, c: Int, d: Long, e: Long) = {
    ...
    val stageInfo = new StageInfo(a, 0, 0, "greetings", b, None, rddInfos, Seq(100, 200, 300),
      "details")
